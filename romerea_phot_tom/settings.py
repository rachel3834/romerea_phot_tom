...
Generated by ./manage.py tom_setup on Sept. 4, 2019, 10:16 p.m.
...
WSGI_APPLICATION = 'romerea_phot_tom.wsgi.application'
...
EXTRA_FIELDS = [
    ...
    {'name': 'gaia_source_id', 'type': 'string'},
    {'name': 'gaia_ra', 'type': 'number'},
    {'name': 'gaia_ra_error', 'type': 'number'},
    {'name': 'gaia_dec', 'type': 'number'},
    {'name': 'gaia_dec_error', 'type': 'number'},
    {'name': 'gaia_phot_g_mean_flux', 'type': 'number'},
    {'name': 'gaia_phot_g_mean_flux_error', 'type': 'number'},
    {'name': 'gaia_phot_bp_mean_flux', 'type': 'number'},
    {'name': 'gaia_phot_bp_mean_flux_error', 'type': 'number'},
    {'name': 'gaia_phot_rp_mean_flux', 'type': 'number'},
    {'name': 'gaia_phot_rp_mean_flux_error', 'type': 'number'},
    {'name': 'vphas_source_id', 'type': 'number'},
    {'name': 'vphas_ra', 'type': 'number'},
    {'name': 'vphas_dec', 'type': 'number'},
    {'name': 'vphas_gmag', 'type': 'number'},
    {'name': 'vphas_gmag_error', 'type': 'number'},
    {'name': 'vphas_rmag', 'type': 'number'},
    {'name': 'vphas_rmag_error', 'type': 'number'},
